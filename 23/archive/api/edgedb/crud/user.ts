...
export async function clearTopicsLearning(hankoId: string) {
  const foundUser = foundUserByHankoId(hankoId)
  return await e
    .update(foundUser, () => ({
      set: {
        topicsLearning: e.set()
      }
    }))
    .run(client)
}
export async function clearTopicsToLearn(hankoId: string) {
  const foundUser = foundUserByHankoId(hankoId)
  return await e
    .update(foundUser, () => ({
      set: {
...
export async function clearTopicsLearned(hankoId: string) {
  const foundUser = foundUserByHankoId(hankoId)
  return await e
    .update(foundUser, () => ({
      set: {
...
export async function clearLinksBookmarked(hankoId: string) {
  const foundUser = foundUserByHankoId(hankoId)
  return await e
    .update(foundUser, () => ({
      set: {
        linksBookmarked: e.set()
      }
    }))
    .run(client)
}
