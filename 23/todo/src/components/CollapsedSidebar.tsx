  ...
  return (
    <>
      ...
      <div class="  text-base " style={{ width: "70px" }} id="sidebar">
        <div class="flex flex-col gap-2  h-full bg-gray-100 dark:bg-neutral-900">
          <div class="flex flex-col gap-2 bg-gray-100 dark:bg-neutral-900 py-4 p-2">
            ...
            >
              <div class="relative">
                ...
                <div
                  id="Number"
                  class={clsx(
                    "absolute bg-gray-100 dark:bg-neutral-900 bottom-0 right-0 text-xs hover:bg-gray-200 transition-all rounded",
            ...
            <div
              id="TitleWrapper"
              class={clsx(
                "flex justify-center cursor-pointer items-center hover:bg-gray-200 transition-all rounded",
            ...
            <div
              id=""
              class={clsx(
                "flex cursor-pointer items-center justify-center transition-all hover:bg-gray-200 rounded",
            ...
            >
              {(tag) => (
                <div
                  ...
                  class="flex hover:bg-gray-200 transition-all py-1 rounded font-semibold flex-row-reverse px-2 items-center justify-center cursor-pointer"
                >
