        ...
        >
          <div class="flex flex-col justify-center items-center">
            ...
            <p
              ...
              style={{ opacity: "0.5" }}
            >
              LA Todo is app that uses AI to help you get things done. It's very
              keyboard driven.
            </p>
            <div class="flex flex-col items-center mt-5">
              <div class="w-full flex flex-col gap-2 mb-2">
                <button
                  class="text-white flex w-full justify-center p-3 bg-black rounded-md active:translate-y-0.5 hover:bg-green-600 hover:border-green-600 hover:-translate-y-1 transition-all invisible lg:visible"
                  onClick={() => {
                ...
                <Show when={showDownload()}>
                  <Motion.div class="flex flex-col w-full gap-2 justify-between items-center">
                    <Motion.div
                      ...
                      class="flex w-full items-center justify-center rounded bg-blue-500 opacity-80"
                    >
                      {/* TODO: have links not be hard coded, take latest release? */}
                      {/* TODO: add release */}
                      {/* <a
                        href="https://github.com/learn-anything/todo/releases/download/app-v0.0.1/KusKus_0.0.1_universal.dmg"
                        class="cursor-pointer h-full w-full flex items-center justify-center p-3"
                      >
                        macOS
                      </a> */}
                    </Motion.div>
              ...
              >
                ...
                <a
                  id="Github"
                  class="w-5 mt-4"
                  href="https://github.com/learn-anything/todo"
                >
                  <Icon name="Github" />
                </a>
              </div>
