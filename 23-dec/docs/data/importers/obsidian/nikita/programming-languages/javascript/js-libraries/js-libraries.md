...
- [Marko Run](https://github.com/marko-js/run) - Marko application framework.
...
- [Simple Statistics](https://github.com/simple-statistics/simple-statistics) - JavaScript implementation of descriptive, regression, and inference statistics. ([Web](https://simple-statistics.github.io/))
...
- [mitata](https://github.com/evanwashere/mitata) - Cross-runtime benchmarking lib and CLI.
...
- [JSPM](https://jspm.org/) - ES Module Package Manager and CDN. ([GitHub](https://github.com/jspm)) ([CLI](https://github.com/jspm/jspm-cli))
...
- [dts-buddy](https://github.com/Rich-Harris/dts-buddy) - Tool for creating .d.ts bundles.
- [UnsuckJS](https://unsuckjs.com/) - Progressively enhance HTML with lightweight JavaScript libraries.
