...
- [ordered](https://github.com/clj-commons/ordered) - Ordered sets and maps.
- [Tiara](https://github.com/quoll/tiara) - Small data structure library.
- [openai-clojure](https://github.com/wkok/openai-clojure) - Clojure functions to drive the OpenAI API.
