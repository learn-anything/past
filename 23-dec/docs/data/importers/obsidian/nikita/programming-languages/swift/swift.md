...
- [Why is Swift so slow (timeout) in compiling this code?](https://forums.swift.org/t/why-is-swift-so-slow-timeout-in-compiling-this-code/61382) ([HN](https://news.ycombinator.com/item?id=36124025))
- [What’s new in Swift 5.9? (2023)](https://www.hackingwithswift.com/articles/258/whats-new-in-swift-5-9)
- [sign-here](https://github.com/Tinder/sign-here) - Tool that enables the creation of Provisioning Profiles and Certificates for deploying Apple based software.
