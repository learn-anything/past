...
- [Why do ML on the Erlang VM? (2023)](https://underjord.io/why-ml-on-erlang.html)
- [How much memory is needed to run 1M Erlang processes? (2023)](https://hauleth.dev/post/beam-process-memory-usage/) ([HN](https://news.ycombinator.com/item?id=36255546))
