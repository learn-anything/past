...
- [http.zig](https://github.com/karlseguin/http.zig) - HTTP/1.1 server for zig.
...
- [zecsi](https://github.com/ryupold/zecsi) - Small game framework made with Zig utilizing the awesome raylib.
...
- [zigrc](https://github.com/Aandreba/zigrc) - Reference-counted pointers for Zig inspired by Rust's Rc and Arc.
- [zig-steamworks](https://github.com/menduz/zig-steamworks) - Steamwork bindings for Zig.
