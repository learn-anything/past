    ...
    <div class="flex flex-col bg-white text-black h-screen">
      ...
      <div class="flex p-5 pt-2 gap-5">
        ...
        <div class="text-lg flex flex-col w-1/2">
          <div class="mb-10">
            We at Learn Anything, respect your privacy and are strongly
            committed to keeping secure any information we obtain from you or
            about you. Todos are never shared with any third party unless AI
            features are used. Then the todos get sent to{" "}
          ...
          <div>
            Please{" "}
            <a class="text-blue-400" href="mailto:mail@learn-anything.xyz">
              contact us
            </a>{" "}
